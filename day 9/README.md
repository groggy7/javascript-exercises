...
_map_: Iterate array elements and modify the array elements. It takes a callback function with elements,  index , array parameter and return a new array.
...
const scoresGreaterEighty = scores.filter((user) => user.score > 80)
