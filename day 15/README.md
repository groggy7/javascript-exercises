...
Lets use the class constructor to pass different properties for the class.
...
Using the class Person we created three persons object. As you can see our class does not contain many properties let us add more properties to the class.
...
When we create a class for some properties we may have an initial value. For instance if you are playing a game, you starting score will be zero. So, we may have a starting score which is zero. In other way, we may have an initial skill and we will acquire some skill after some time.
